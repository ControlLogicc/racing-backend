...
public class OwnerRegistrationController {
    ...
    @GetMapping("/{registrationId}/eligible-jockeys")
    @PreAuthorize("hasRole('OWNER')")
    public ResponseEntity<List<EligibleJockeyForInvitationResponse>> getEligibleJockeys(
            @PathVariable Long registrationId) {
        return ResponseEntity.ok(jockeyRaceRegistrationService.getEligibleJockeys(registrationId));
    }
}
