...
/*
        ...
        void testCreateEntrySuccess() throws Exception {
                ...
                RaceEntryResponse response = objectMapper.readValue(result.getResponse().getContentAsString(),
        ...
        void testGetEntryAndEntriesForRace() throws Exception {
                ...
                MvcResult result = mockMvc.perform(post("/api/entries")
                                ...
                                .andExpect(status().isOk())
                                .andReturn();
                RaceEntryResponse created = objectMapper.readValue(result.getResponse().getContentAsString(),
                                RaceEntryResponse.class);
        ...
        void testUpdateWeightSuccess() throws Exception {
                ...
                RaceEntryResponse response = objectMapper.readValue(updatedResult.getResponse().getContentAsString(),
                                RaceEntryResponse.class);
        ...
        void testBatchWeightCheckPassedAndFailedSuccess() throws Exception {
                ...
                RaceEntryResponse[] responses = objectMapper.readValue(result.getResponse().getContentAsString(),
                                RaceEntryResponse[].class);
                assertEquals(2, responses.length);
                ...
                assertEquals(0, new BigDecimal("0.00").compareTo(refreshedEntry1.getLeadWeight()));
                assertEquals(0, new BigDecimal("55.20").compareTo(refreshedEntry1.getCarriedWeight()));
                assertEquals("passed", refreshedEntry1.getWeightCheckStatus());
                ...
                assertEquals(0, new BigDecimal("0.00").compareTo(refreshedEntry2.getLeadWeight()));
                assertEquals(0, new BigDecimal("58.50").compareTo(refreshedEntry2.getCarriedWeight()));
                assertEquals("failed", refreshedEntry2.getWeightCheckStatus());
        ...
        private RaceEntry saveDeclaredEntry(RaceRegistration registration, RaceInvitation invitation, Horse horse,
                        Jockey jockey, Short gateNumber) {
                return raceEntryRepository.save(RaceEntry.builder()
                                .race(testRace)
                                .registration(registration)
                                .invitation(invitation)
